...
- **NO MONEY ON THE PAGE (absolute — Nathan, Jul 5, 2026).** Never publish anyone's rates, day rates, or payment amounts in any case study. Beyond amounts: no transactional framing at all — no "commissioned," no PayPal/receipt/ledger references, no proceeds or revenue splits. Collaborations are presented as creative partnerships. Payment records in the evidence files are internal dating tools only.
- **LALORK scope (Nathan, Jul 5, 2026):** the Notation Anticipation page covers LALORK for the purposes of a product-design portfolio; no separate LALORK page or flagship. (PORTFOLIO_REFRAME.md deleted same day as superseded by this guide.)

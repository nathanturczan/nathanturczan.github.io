...
7. **AAX — RULED (Nathan, Jul 5, 2026)**: "was AAX ever real - not that i know of." The current tonalign.html platform line claiming AAX is wrong; the rewrite ships **VST3 / AU only** (macOS, Windows).
8. **Draft v1 rulings (Jul 5, 2026)**: Brady sequencing in the draft ("Brady came in the following week," after the Jul 26 screenshot) is a **non-issue** despite Brady's Jul 1 first commits — Nathan: "my plans and wireframes existed before talking to brady… so no worry about timeline." The three "Not X. It's Y" pivots and the meta-commentary paragraph were fixed in `/Users/soney/Downloads/tonalign_rewrite.md` same day.
